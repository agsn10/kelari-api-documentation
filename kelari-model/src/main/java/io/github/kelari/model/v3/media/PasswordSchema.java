...
/**
 * Represents a Password Schema in the OpenAPI 3.0.1 specification.
 * <p>
 * The {@code PasswordSchema} class extends {@link Schema} to represent a schema for password-based values.
 * It supports setting default values, format, and enumeration items. It also provides a method to cast
 * arbitrary objects into {@code String} values.
 * </p>
 *
 * <p>
 ...
 * {@code addEnumItem(String)} method sets an enumeration of valid values.
 * </p>
 *
 ...
 * <pre>
 * PasswordSchema passwordSchema = new PasswordSchema();
 * passwordSchema._default("mySecretPassword")
 *              .addEnumItem("admin123")
 *              .addEnumItem("user456");
 * </pre>
 *
...
public class PasswordSchema extends Schema<String> {
    ...
    private static final Logger LOGGER = Logger.getLogger(PasswordSchema.class.getName());

    /**
     * Constructs a new {@code PasswordSchema} with default values.
     * <p>
     * The schema type is set to "string" and the format is set to "password".
     * </p>
     */
     ...
     * @return This {@code PasswordSchema} object for method chaining.
     */
    @Override
     ...
     *
     * @param format The format to be set (e.g., "password").
     * @return This {@code PasswordSchema} object for method chaining.
     */
    @Override
    ...
    /**
     * Checks if this {@code PasswordSchema} is equal to another object.
     * <p>
    ...
    /**
     * Computes the hash code for this {@code PasswordSchema}.
     * <p>
    ...
    /**
     * Returns a string representation of this {@code PasswordSchema}.
     * <p>
